...
String uNickName = mMgr.getMemberuNickName(uId);
String uName = mMgr.getMemberuNickName(uId);
%>
    		...
    		<div id="contents" class="bbsWrite">
				...
				<form name="writeFrm" enctype="multipart/form-data" 
					...
					<table>
						<tbody>
							<tr>
								<td class="req">닉네임</td>  <!-- td.req 필수입력 -->
								<td>
									<%=uNickName%>
									<input type="hidden" name="uNickName" id="uNickName" value="<%=uNickName%>">
