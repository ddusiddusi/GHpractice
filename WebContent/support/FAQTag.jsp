...
Vector<CustomBoardBean> checkList = null;

checkList = bMgr.getPayList(supSearch); 
...
<div id="wrap">
    	...
    	<!-- div#supContents -->
    			<div id="threeCol" class="dFlex">			
					<div class="threeColItem"><a href="/support/FAQ.jsp">FAQ</a></div>
		...
		<!-- div#threeCol -->
    		...
    		CustomBoardBean chkBean = checkList.get(i);
    		int num = chkBean.getNum();
    		String subject = chkBean.getSubject();
